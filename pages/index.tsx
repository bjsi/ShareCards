...
export default function Home({ decks }: HomeProps) {
  return (
    <Layout meta={<Meta title="Home" desc={O.none} canonical="TODO" />}>
      <p>
       <b>Share Cards</b> is a flashcard sharing website for <a href="https://www.supermemo.wiki/en/supermemo">SuperMemo</a> users. Share Cards is built entirely on top of GitHub, allowing <Link href="/authors"><a>deck authors</a></Link> to effortlessly share their masterpieces with the community through GitHub repositories. Commenting, liking, voting and downloading is all implemented through GitHub, so even if Share Cards dies, deck owners' data, comments and stars will live on!
      </p>
      ...
      <p>
        Browse some of the community's most popular decks:
      </p>
	...
	:(
	<CardColumns>{decks.map(deck => (
          <FlashcardDeck key={`${deck.deck.title} ${deck.repo.owner.login}`} deck={deck} />))}
	</CardColumns>
